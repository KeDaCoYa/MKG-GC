...
class MultiBioSyn:
    ...
    def init_sparse_weight(self, initial_sparse_weight):
        ...
        return self.bc5cdr_disease_sparse_weight,self.bc5cdr_chem_sparse_weight,self.ncbi_disease_sparse_weight
...
class MyRerankNet(nn.Module):
    ...
    def __init__(self,config, dense_encoder,sparse_weight,device):
        ...
        self.device = device
        self.bc5cdr_disease_sparse_weight,self.bc5cdr_chem_sparse_weight, self.ncbi_disease_sparse_weight = sparse_weight
