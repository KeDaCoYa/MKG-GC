...
logger = logging.getLogger("main.MultiBinaryInterLinearSpanForEight")

class MultiBinaryInterLinearSpanForEight(BaseBert):
    def __init__(self,config):
        super(MultiBinaryInterLinearSpanForEight, self).__init__(config)
