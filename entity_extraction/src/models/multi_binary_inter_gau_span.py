...
logger = logging.getLogger("main.MultiBinaryInterGAUSpanForEight")

class MultiBinaryInterGAUSpanForEight(BaseBert):
    def __init__(self,config):
        super(MultiBinaryInterGAUSpanForEight, self).__init__(config)
        ...
        self.chem_drug_mid_linear = GAU(dim=768,dropout=0.4)
        self.gene_protein_mid_linear = GAU(dim=768,dropout=0.4)
        self.disease_mid_linear = GAU(dim=768,dropout=0.4)
        self.cell_line_mid_linear = GAU(dim=768,dropout=0.4)
        self.cell_type_mid_linear = GAU(dim=768,dropout=0.4)
        self.dna_mid_linear = GAU(dim=768,dropout=0.4)
        self.rna_mid_linear = GAU(dim=768,dropout=0.4)
        self.species_mid_linear = GAU(dim=768,dropout=0.4)
